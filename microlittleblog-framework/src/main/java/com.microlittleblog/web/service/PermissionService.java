...
public class PermissionService {
     ...
     * 没有权限，hidden用于前端隐藏按钮
     */
    private static final String NO_ACCESS = "hidden";
    ...
    public String hasPermi(String permission) {
        return isPermitted(permission) ? StringUtils.EMPTY : NO_ACCESS;
    }
    ...
    public String lacksPermi(String permission) {
        return isLacksPermitted(permission) ? StringUtils.EMPTY : NO_ACCESS;
    }
    ...
    public String hasAnyPermi(String permissions) {
        return hasAnyPermissions(permissions, PERMISSION_DELIMETER) ? StringUtils.EMPTY : NO_ACCESS;
    }
    ...
    public String hasRole(String role) {
        return isRole(role) ? StringUtils.EMPTY : NO_ACCESS;
    }
    ...
    public String lacksRole(String role) {
        return isLacksRole(role) ? StringUtils.EMPTY : NO_ACCESS;
    }
    ...
    public String hasAnyRoles(String roles) {
        return isAnyRoles(roles, ROLE_DELIMETER) ? StringUtils.EMPTY : NO_ACCESS;
    }
